    ...
    <header className="w-full bg-white shadow-md p-3">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className="relative">
          <input
            className="border-2 border-gray-300 rounded-md px-4 py-2 pl-10 focus:border-yellow-400 outline-none transition duration-200 w-72"
            type="text"
            placeholder="Search..."
          />
          <svg
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="relative">
            <img
              src={userIcon}
              alt="User Profile"
              className="w-10 h-10 rounded-full border-2 border-gray-900 cursor-pointer"
